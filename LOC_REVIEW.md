...
`LocReview/`. Same 616 keys everywhere, checked by script and by the menu
...
|---|---|---|---|
| ja | 616 | Noto Sans JP (assign on UISkin) | |
| zh-CN | 616 | Noto Sans SC (assign on UISkin) | |
| zh-TW | 616 | Noto Sans TC (assign on UISkin) | |
| ko | 616 | Noto Sans KR (assign on UISkin) | |
| es | 616 | skin font | |
| pt-BR | 616 | skin font | |
| fr | 616 | skin font | |
| de | 616 | skin font | |
| it | 616 | skin font | |
| ru | 616 | skin font, needs Cyrillic glyphs (OtherFont slot if the hand-drawn font lacks them) | |
| tr | 616 | skin font, needs ı ğ ş İ glyphs | |
