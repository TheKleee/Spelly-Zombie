...
{
    /// A PARTICLE IN BEHAVIOR, NOT IN SHAPE (Marko Aug 9: "It's a particle
    ...
    /// spell"). Spell.SpawnMatter attaches this to HIS conjured matter — his
    /// shape, his material, his sides-pick-the-shape rule, all untouched.
    ...
    public class MatterStrike : MonoBehaviour
    {
        ...
        void FixedUpdate()
        {
            ...
            if (HandGrab.LocalHeldBody == _rb) { _held = true; return; } // in his hand

            // THROWN = NO LONGER A PARTICLE (Marko Aug 9: "they stop being
            // particles when I throw them and fall to the ground afterwards
            // unless they see an opponent") — after his hand lets go it flies
            ...
            // THE SPELL EXPIRES (Marko Aug 9: "the overall spell effect should
        ...
        {
            // slamming OR thrown: the landing IS the detonation (Marko #5) —
