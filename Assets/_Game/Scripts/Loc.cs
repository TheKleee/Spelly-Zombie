...
namespace SpellyZombie
{
    ...
    public static class Loc
    {
        static readonly Dictionary<string, string> _en = new Dictionary<string, string>
        {
            ...
            ["hint.alt"] = "Hold {0} to draw faster",
            ["hint.combine"] = "Draw more runes inside of the same seal to combine them",
            ["hint.lift"] = "Draw ink on things and press {0} to lift them",
            ["hint.erase"] = "Erasing returns the ink to your wand",
            ["hint.body"] = "Press {0} to paint runes on your own body",
            ...
            ["browse.inlobby"] = "In the lobby",
            ["browse.inmatch"] = "In a match",
            ["browse.upmin"] = "Up {0} min",
            ["browse.uph"] = "Up {0} h {1} min",
            ["hint.sealshape"] = "A circle is the weakest seal, a triangle the strongest",
            ["hint.sealline"] = "Draw two sides of a triangle around your runes and {0} closes it",
            ["opt.ghost"] = "Ghost lines",
            ["side.pillar.acolyte"] = "Become an acolyte",
            ["side.pillar.wizard"] = "Become a wizard",
            ["seal.aim"] = "Seal it, the book draws the ring",
            ["mc.area.arrive"] = "Arrives in, seconds",
            ["mc.note.arrive"] = "0 lets the game pick the speed. Slower than 5 metres a second it settles in, faster it slams.",
            ["opt.tab.keys"] = "Controls",
            ["keys.note"] = "Click a key or a button, then press the new one. Escape keeps the old one",
            ["keys.press"] = "Press the new key or button now. Escape keeps the old one",
            ["keys.action"] = "Action",
            ["keys.keyboard"] = "Keyboard",
            ["keys.pad"] = "Controller",
            ["keys.reset"] = "Back to the default keys",
            ["keys.act.forward"] = "Walk forward",
            ["keys.act.back"] = "Walk back",
            ["keys.act.left"] = "Walk left",
            ["keys.act.right"] = "Walk right",
            ["keys.act.jump"] = "Jump, fly up",
            ["keys.act.crouch"] = "Crouch, fly down",
            ["keys.act.sprint"] = "Run",
            ["keys.act.draw"] = "Draw",
            ["keys.act.erase"] = "Erase",
            ["keys.act.precise"] = "Draw faster",
            ["keys.act.use"] = "Grab, throw, use",
            ["keys.act.drop"] = "Drop, let go",
            ["keys.act.body"] = "Paint body, pose, watch",
            ["keys.act.menu"] = "Menu",
            ["keys.act.ready"] = "Ready",
            ["keys.act.notready"] = "Not ready",
            ["keys.act.talk"] = "Push to talk",
            ["keys.act.prev"] = "Previous page",
            ["keys.act.next"] = "Next page",
            ["watch.many"] = "Watching {0} of {1} · 1-0 picks · Draw a seal on it to blow it",
            ["watch.one"] = "Draw a seal on it to blow it · R leaves",
            ["mc.behaviour.rampages"] = "Rampages",
            ["mc.note.rampages"] = "Throws random spells from its list all over the place, about one a second, and never runs away. Spells from its own side cannot hurt it.",
            ["opt.keys.title"] = "Videos and photos",
            ["opt.key.clip"] = "Start or stop a video",
            ["opt.key.photo"] = "Take a photo",
            ["opt.key.folder"] = "Open their folder (in the lobby)",
            ["opt.keys.note"] = "Saved in your Videos folder, under Spelly Zombie. The interface is never in them",
            ["ver.mine"] = "That lobby runs a newer version. Quit the game and let Steam update yours",
            ["ver.theirs"] = "That lobby runs an older version. Its host has to update the game",
            ["ver.differs"] = "That lobby runs a different version of the game",
            ["wand.hosed"] = "The pour is too strong. Step back to draw",
            ["menu.extras"] = "Extras",
            ...
            ["photo.list"] = "Objects",
            ["photo.list.note"] = "Pick one to change it. Pick it again to go to it. Clicking the same spot again reaches the one behind.",
            ["photo.ground"] = "Ground",
            ["photo.ground.island"] = "The island",
            ["photo.ground.again"] = "Another island",
            ["photo.find"] = "Find it",
            ["photo.lock"] = "Lock it",
            ["photo.unlock"] = "Unlock it",
            ["photo.hint.locked"] = "Locked: drag anywhere to move it, Shift drag lifts it. {0} unlocks it",
            ["photo.parts"] = "Parts",
            ["photo.shade"] = "Shaded characters",
            ...
            ["photo.seethrough.note"] = "Steam wants this one transparent",
            ["photo.back"] = "Behind",
            ["photo.back.world"] = "The world",
            ["photo.back.colour"] = "A color",
            ["photo.back.none"] = "Transparent",
            ["photo.back.none.note"] = "Transparent: the grey is not in the photo. Glow and blur stay off so the edges stay clean.",
            ["photo.red"] = "Red",
            ["photo.green"] = "Green",
            ["photo.blue"] = "Blue",
