...
namespace SpellyZombie
{
    ...
    /// the material's base weight ("size can be 1 = small, 2 = medium,
    /// 3 = large, 4 = xL, 5 = xxL").
    ...
    ///
    /// NO RIGIDBODY UNTIL IT EARNS ONE : a rooted prop stays plain
    ...
    public class Liftable : MonoBehaviour
    {
        ...
        /// THE WORLD-OR-PROP LINE (the fall-through, Aug 4: "Grabbing the
        /// liquid ball made me fall through the ground indefinitely... I guess
        /// I lifted the ground collider just a little bit"). the aim ray
        /// missed the blob, hit the FLOOR, and the floor - carrying every
        /// stroke had ever drawn on it - out-inked its own anchor and tore
        ...
        /// (the fall-through - convexing the village floor bridged its
        /// concavities and stood INSIDE the hull, falling forever). A mesh
