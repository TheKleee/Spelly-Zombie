...
namespace SpellyZombie
{
    ...
    public class GrimoireAbsorb : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            // ACOLYTES DO NOT ABSORB — BUT THEY DECLARE (Marko Aug 10:
            ...
            // FULL HANDS = NO BOOK TALK (Marko Aug 10: "when I'm holding
            ...
            if (target == null)
            {
                ...
                if (declRune)
                {
                    if (_promptRune != _inkRune || _declarePrompt == null)
                    {
                        ...
                        _declarePrompt = $"declare this as {RuneLibrary.IconInlineFor(_inkRune, Grimoire.LocalPlayerId)}";
                    }
