...
| menu.wishlist | ♥ Wishlist on Steam | ♥ Steamでウィッシュリストに入れる | ♥ on Steam, put into the wishlist | ウィッシュリスト is Steam Japan's own term |
...
| inspect.add | add friend on Steam | Steamでフレンドに追加 | on Steam, add to friends | フレンド is Steam Japan's word |
| inspect.close | I closes | Iで閉じる | with I, close | |
