...
| menu.wishlist | ♥ Wishlist on Steam | ♥ Auf die Steam-Wunschliste | ♥ onto the Steam wish list | Wunschliste is Steam Germany's term |
...
| inspect.add | add friend on Steam | auf Steam als Freund hinzufügen | on Steam as friend add | |
| inspect.close | I closes | I schließt | I closes | |
...
| stand.lanhost | LAN host | LAN hosten | host on LAN | book stand, the LAN row: host over the local network |
| stand.lanjoin | LAN join | LAN beitreten | join on LAN | book stand, the LAN row: join the address in the field |
