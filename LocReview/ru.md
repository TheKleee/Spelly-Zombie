...
| menu.wishlist | ♥ Wishlist on Steam | ♥ В список желаемого в Steam | ♥ into the list of the wished-for on Steam | Steam Russia's term |
...
| inspect.add | add friend on Steam | добавить в друзья в Steam | to add into friends on Steam | |
| inspect.close | I closes | I закрывает | I closes | |
